...
class MdgPayloadDecorator() {
  ...
  def status[A](badgeId: BadgeIdentifier, asr: AuthorisedRequest[A], correlationId: CorrelationId, date: DateTime, mrn: Mrn, dmirId: DeclarationManagementInformationRequestId): NodeSeq = {
    ...
    xsi:schemaLocation="http://gov.uk/customs/retrieveDeclarationInformation/v1 request_schema.xsd">
      <n1:requestCommon>
        ...
        <n1:badgeIdentifier>{badgeId.toString}</n1:badgeIdentifier>

...
case class CustomsDeclarationsMetricsRequest(
                                              eventType: String,
...
object CustomsDeclarationsMetricsRequest {
  implicit val format: Format[CustomsDeclarationsMetricsRequest] = Json.format[CustomsDeclarationsMetricsRequest]
}
